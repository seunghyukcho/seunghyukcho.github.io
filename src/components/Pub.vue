          ...
          <div class="card has-text-left">
            <header class="card-header">
              ...
              <button class="card-header-icon">
                <span class="icon">
                  <a class="fas fa-external-link-alt" href="https://arxiv.org/abs/2205.13371"/>
                </span>
              </button>
            </header>
        ...
        <div class="column">
          <div class="card has-text-left">
            <header class="card-header">
              <div class="card-header-title">
                <p>
                Hyperbolic VAE via Latent Gaussian Distributions <span style="color:magenta;"> [ICML TAGML '23] </span>
                </p>
              </div>
              <button class="card-header-icon">
                <span class="icon">
        ...
        <div class="column">
          <div class="card has-text-left">
            <header class="card-header">
              <div class="card-header-title">
                <p>
                Curve Your Attention: Mixed-Curvature Transformers for Graph Representation Learning <span style="color:magenta;"> [ICML TAGML '23] </span>
                </p>
              </div>
              <button class="card-header-icon">
                <span class="icon">
